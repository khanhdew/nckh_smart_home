...
import {addADeviceToUser} from '../services/firebase';
...
const AddDeviceModal = ({setModalVisible}: IProps) => {
  ...
  const addButtonPressHandle = async (e: GestureResponderEvent): void => {
    console.log(email);
        ...
        {step === 1 ? (
          <>
            <View
              ...
              <Text style={{color: '#4a4a4a'}} onPress={addDeviceHelpHandle}>
          ...
          <>
            <View>
              ...
              <TextInput
                ...
                disabled={!(inputLocationValue && inputTypeValue)}
